  ...
  return (
    <div className="min-h-screen bg-brand-white">
      ...
      <motion.section 
        ...
        className="relative py-24 bg-gradient-to-br from-brand-white to-brand-gold/10"
      >
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-brand-black/70 max-w-3xl mx-auto">
              Creating sophisticated indoor environments with custom pergola structures and architectural elements.
            </p>
          </motion.div>
      ...
      <motion.section
        ...
        className="py-24 bg-gradient-to-r from-brand-gold/10 to-brand-gray/10"
      >
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-brand-black mb-6">
            Ready to Enhance Your Indoor Space?
          </h2>
          <p className="text-xl text-brand-black/70 mb-8 max-w-2xl mx-auto">
            Let's create sophisticated interior environments with our custom architectural elements.
          </p>
          <motion.button
