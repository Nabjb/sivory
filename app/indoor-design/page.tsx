...
export default function IndoorDesign() {
  ...
  useEffect(() => {
    async function fetchSubcategories() {
      try {
        const query = `*[_type == "subcategory" && category->title == "Indoor"] | order(title asc) {
          _id,
          title,
          slug,
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white/70 max-w-2xl mx-auto leading-relaxed">
              Choose a category to explore our indoor design projects
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {subcategories.map((subcategory, index) => (
              ...
              >
                <Link href={`/indoor-design/${subcategory.slug.current}`}>
